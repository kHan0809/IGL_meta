...
np.save('../IGL_data/DrawerOpen_hBC_x_sg0',np_x_sg0)
np.save('../IGL_data/DrawerOpen_hBC_y_sg0',np_y_sg0)
np.save('../IGL_data/DrawerOpen_hBC_x_sg1',np_x_sg1)
np.save('../IGL_data/DrawerOpen_hBC_y_sg1',np_y_sg1)
